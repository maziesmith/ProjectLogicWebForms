...
<asp:FormView ID="FvPM" runat="server" CellPadding="4" DataKeyNames="ProjectID" DataSourceID="FvPMSQL" OnItemCommand="FvPM_ItemCommand" OnDataBound="FvPM_DataBound">
	<ItemTemplate>
			...
			<div class="lside">
				<table>
					...
					<tr>
						<td>MTO Complete:</td>
						<td class="AlignRight">
							<asp:Label ID="TxtMTOComplete" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("MTO_Complete", "{0:d}") %>'/>
						</td>
						<td>Reviewed By:</td>
						<td>
					...
					<tr>
						...
						<td class="AlignRight">
							<asp:Label ID="TxtShopsReviewed" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("Shops_Reviewed", "{0:d}") %>'/>
						</td>
					</tr>
					<tr>
						<td>Mat'l Approved:</td>
						<td class="AlignRight">
							<asp:Label ID="TxtMatlApproved" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("PM_DateMatlApproved", "{0:d}") %>'/>
						</td>
						<td>Shops Sent:</td>
						<td class="AlignRight">
							<asp:Label ID="TxtShopsSent" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("CAD_DateSent", "{0:d}") %>'/>
						</td>
					</tr>
					<tr>
						<td>Mat'l Ordered:</td>
						<td class="AlignRight">
							<asp:Label ID="TxtMatlOrdered" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("PM_DateMatlOrderComplete", "{0:d}") %>'/>
						</td>
						<td>Shops Received:</td>
						<td class="AlignRight">
							<asp:Label ID="TxtShopsReceived" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("Shops_Recd", "{0:d}") %>'/>
						</td>
					</tr>
					<tr>
						<td>ESD From Vendor:</td>
						<td class="AlignRight">
							<asp:Label ID="TxtESDFromVendor" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("PM_ESD_ShopDrawings", "{0:d}") %>'/>
						</td>
						<td>Shops Resubmitted:</td>
						<td class="AlignRight">
							<asp:Label ID="TxtShopsRevised" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("Shops_Revised", "{0:d}") %>'/>
						</td>
					</tr>
					<tr>
						<td>Mat'l Received</td>
						<td class="AlignRight">
							<asp:Label ID="TxtMatlRecd" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("PM_DateMatlRecd", "{0:d}") %>'/>
						</td>
						<td>Shops Approved:</td>
						<td class="AlignRight">
							<asp:Label ID="TxtShopsApproved" runat="server" CssClass="DateBox AlignRight" Text='<%# Bind("PM_DateShopsApproved", "{0:d}") %>'/>
						</td>
					</tr>
				</table>
			</div> <!-- end div left -->
		...
		<asp:LinkButton runat="server" ID="LbEditHeader" Text="Edit Date Info" CommandName="Edit" />
	</ItemTemplate>
	<EditItemTemplate>
		<div class="clear">
			<div class="lside">
				<table>
					<tr>
						<td>Project Manager:</td>
						<td colspan="3">
							<asp:DropDownList ID="DdlPM" runat="server" AutoPostBack="true" DataSourceID="DdlAllEmPloyeeSQL" Enabled="True"
											  DataTextField="Name" DataValueField="EmployeeID" SelectedValue='<%# Bind("Scope_PM_EmployeeID") %>'>
							</asp:DropDownList>
						</td>
					</tr>
		...
		<asp:TemplateField HeaderText="Shipment #" SortExpression="ShipmentNo">
			<ItemTemplate>
				<a href="../ShipmentDetails?PSID=<%# Eval("ProjectShipmentID") %>"
				   onclick="window.open('../ShipmentDetails?PSID=<%# Eval("ProjectShipmentID") %>', 'newwindow', 'width=600,height=500');return false;">
					<asp:Label ID="LblShipmentNo" runat="server" Text='<%# Bind("ShipmentNo") %>'/>
				</a>
			</ItemTemplate>
		</asp:TemplateField>
...
<asp:View ID="ChangeOrders" runat="server">
	<asp:GridView ID="GvChangeOrders" runat="server" AutoGenerateColumns="False" DataKeyNames="ProjectChangeOrderID" ShowFooter="False"
		...
		<Columns>
			<asp:TemplateField HeaderText="#" SortExpression="SeqNo">
				<FooterTemplate>
					...
					&nbsp;<asp:LinkButton runat="server" ID="LbDeleteCO" Text="Del" CommandName="Delete"/>
				</FooterTemplate>
				<ItemTemplate>
					<a href="../ChangeOrderDetails?PCOID=<%# Eval("ProjectChangeOrderID") %>"
					   onclick="window.open('../ChangeOrderDetails?PCOID=<%# Eval("ProjectChangeOrderID") %>&ProjectID=<%# Eval("ProjectID") %>', 'newwindow', 'width=500,height=800');return false;">
	...
	<br />
	<asp:LinkButton runat="server" ID="LbRefresh" Text="Refresh" CommandName="Refresh" OnClick="LbRefresh_Click" />
</asp:View>
...
<asp:SqlDataSource ID="GvChangeOrdersSQL" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectLogicTestConnectionString %>"
				...
				ApprovalCode, Description, NumPanels, Amount, IsCommissionable, DateDue, DateRecd, Status, ProjectID 
		...
		WHERE (ProjectID = @ProjectID)"
				...
				@NumPanels, @Amount, @IsCommissionable, @DateDue, @DateRecd, @Status)"
				   DeleteCommand="DELETE FROM tblProjectChangeOrder WHERE ProjectChangeOrderID = @ProjectChangeOrderID">
	<SelectParameters>
		<asp:RouteParameter Name="ProjectID" Type="Int32" RouteKey="ProjectID"/>
	</SelectParameters>
	<InsertParameters>
	...
	<DeleteParameters>
		<asp:Parameter Name="ProjectChangeOrderID" Type="Int32"/>
	</DeleteParameters>
</asp:SqlDataSource>
...
<asp:SqlDataSource ID="FvPMSQL" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectLogicTestConnectionString %>"
		...
		FROM tblProject 
		WHERE (ProjectID = @ProjectID)"
				   UpdateCommand="UPDATE tblProject SET 
			Scope_PM_EmployeeID = @Scope_PM_EmployeeID,
			MTO_Complete = @MTO_Complete,
			MTO_Complete_EmployeeID = @MTO_Complete_EmployeeID,
			PM_DateMatlApproved = @PM_DateMatlApproved,
			PM_DateMatlOrderComplete = @PM_DateMatlOrderComplete,
			PM_ESD_ShopDrawings = @PM_ESD_ShopDrawings,
			PM_DateMatlRecd = @PM_DateMatlRecd,
			Shops_Reviewed_EmployeeID = @Shops_Reviewed_EmployeeID,
			Shops_Reviewed = @Shops_Reviewed,
			CAD_DateSent = @CAD_DateSent,
			Shops_Recd = @Shops_Recd,
			Shops_Revised = @Shops_Revised,
			PM_DateShopsApproved = @PM_DateShopsApproved
		WHERE ProjectID = @ProjectID">
	<SelectParameters>
		<asp:RouteParameter Name="ProjectID" Type="Int32" RouteKey="ProjectID"/>
	</SelectParameters>
	<UpdateParameters>
		...
		<asp:Parameter Name="MTO_Complete" Type="DateTime"/>
		<asp:Parameter Name="MTO_Complete_EmployeeID" Type="Int32"/>
		<asp:Parameter Name="PM_DateMatlApproved" Type="DateTime"/>
		<asp:Parameter Name="PM_DateMatlOrderComplete" Type="DateTime"/>
		<asp:Parameter Name="PM_ESD_ShopDrawings" Type="DateTime"/>
		<asp:Parameter Name="PM_DateMatlRecd" Type="DateTime"/>
		<asp:Parameter Name="Shops_Reviewed_EmployeeID" Type="Int32"/>
		<asp:Parameter Name="Shops_Reviewed" Type="DateTime"/>
		<asp:Parameter Name="CAD_DateSent" Type="DateTime"/>
		<asp:Parameter Name="Shops_Recd" Type="DateTime"/>
		<asp:Parameter Name="Shops_Revised" Type="DateTime"/>
		<asp:Parameter Name="PM_DateShopsApproved" Type="DateTime"/>
