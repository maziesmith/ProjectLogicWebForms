...
<EditItemTemplate>
    <table>
        <tr>
            <td>Project #:</td>
            <td>
                <asp:TextBox ID="txtProjectID" runat="server" CssClass="DateBox" Text='<%# Eval("ProjectID") %>'/>
            </td>
        </tr>
        <tr>
            <td>Shipment #:</td>
            <td>
                <asp:TextBox ID="txtShipmentNo" runat="server" CssClass="NumBox" Text='<%# Bind("ShipmentNo") %>'/>
            </td>
        </tr>
        <tr>
            <td>Description:</td>
        ...
        <tr>
            <td>Requested:</td>
            <td>
                <asp:TextBox ID="txtDateRequested" runat="server" Text='<%# Bind("DateRequested", "{0:MM/dd/yyyy}") %>'/>
            </td>
        ...
        <tr>
            <td>Assigned:</td>
            <td>
                <asp:TextBox ID="txtDateAssigned" runat="server" Text='<%# Bind("DateAssigned", "{0:MM/dd/yyyy}") %>'/>
            </td>
    ...
    <table>
        <tr>
            <td>Name:</td>
            <td colspan="3">
                <asp:TextBox ID="txtShipToName" runat="server" CssClass="LongBox" Text='<%# Bind("ShipToName") %>'/>
            </td>
        </tr>
        <tr>
            <td>Address:</td>
            <td colspan="3">
                <asp:TextBox ID="txtShipToAddress" runat="server" CssClass="LongBox" Text='<%# Bind("ShipToAddress") %>'/>
            </td>
        </tr>
        <tr>
            <td>City, ST Zip</td>
            <td>
                <asp:TextBox ID="txtShipToCity" runat="server" Text='<%# Bind("ShipToCity") %>'/>
            </td>
            <td>
                <asp:TextBox ID="txtShipToState" runat="server" CssClass="NumBox" Text='<%# Bind("ShipToState") %>'/>
            </td>
            <td>
                <asp:TextBox ID="txtShipToZip" runat="server" CssClass="NumBox" Text='<%# Bind("ShipToZip") %>'/>
            </td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td>Date Shipped:</td>
            <td>
                <asp:TextBox ID="txtDateShipped" runat="server" Text='<%# Bind("DateShipped", "{0:MM/dd/yyyy}") %>'/>
            </td>
...
<ItemTemplate>
    <table>
        ...
        <tr>
            <td>Requested:</td>
            <td>
                <asp:Label ID="lblDateRequested" runat="server" Text='<%# Bind("DateRequested", "{0:MM/dd/yyyy}") %>'/>
            </td>
        </tr>
        <tr>
            <td>Assigned:</td>
            <td>
                <asp:Label ID="lblDateAssigned" runat="server" Text='<%# Bind("DateAssigned", "{0:MM/dd/yyyy}") %>'/>
            </td>
        </tr>
    </table>
    <br/>
    ...
    <table>
        <tr>
            <td>Name:</td>
            <td colspan="3">
                <asp:Label ID="lblShipToName" runat="server" Text='<%# Bind("ShipToName") %>'/>
            </td>
        </tr>
        <tr>
            <td>Address:</td>
            <td colspan="3">
                <asp:Label ID="lblShipToAddress" runat="server" Text='<%# Bind("ShipToAddress") %>'/>
            </td>
        </tr>
        <tr>
            <td>City, ST Zip</td>
            <td>
                <asp:Label ID="lblShipToCity" runat="server" Text='<%# Bind("ShipToCity") %>'/>
            </td>
            <td>
                <asp:Label ID="lblShipToState" runat="server" Text='<%# Bind("ShipToState") %>'/>
            </td>
            <td>
                <asp:Label ID="lblShipToZip" runat="server" Text='<%# Bind("ShipToZip") %>'/>
            </td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td>Date Shipped:</td>
            <td>
                <asp:Label ID="lblDateShipped" runat="server" Text='<%# Bind("DateShipped", "{0:MM/dd/yyyy}") %>'/>
            </td>
        </tr>
        <tr>
            <td>Notes:</td>
    ...
    &nbsp;<asp:LinkButton ID="NewButton" runat="server" CausesValidation="False" CommandName="NewShipment" Text="New"/>
</ItemTemplate>
</asp:FormView>
</asp:View>
