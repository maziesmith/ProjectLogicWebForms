...
<asp:FormView ID="fvHeader" runat="server" CellPadding="4" DataKeyNames="ProjectID" DataSourceID="fvHeaderSQL">
	<ItemTemplate>
		<h1><asp:Label ID="lblProjectID" runat="server" Text='<%# Eval("ProjectID") %>'/> - <asp:Label ID="lblProjectName" runat="server" Text='<%# Eval("ProjectName") %>'/>
		</h1>
	</ItemTemplate>
...
<div id="lside">
	<table>
		...
		<tr>
			<td>PM: </td>
			<td colspan="4">
				<asp:Label ID="Label7" runat="server" Text='<%# Bind("PM") %>'/>
			</td>
		</tr>
		<tr>
			<td>Series: </td>
			<td colspan="4">
				<asp:Label ID="Label8" runat="server" Text='<%# Bind("Series") %>'/>
			</td>
		</tr>
		<tr>
...
<div id="rside">
	<table>
		...
		<tr>
			<td>Contact:</td>
			<td colspan="3">
				<asp:Label ID="CustContactLabel" runat="server" Text='<%# Bind("CustContact") %>'/>
			</td>
		</tr>
		<tr>
			<td>Address 1:</td>
			<td colspan="3">
				<asp:Label ID="CustAddr1Label" runat="server" Text='<%# Bind("CustAddr1") %>'/>
			</td>
		</tr>
		<tr>
			<td>Address 2:</td>
			<td colspan="3">
				<asp:Label ID="CustAddr2Label" runat="server" Text='<%# Bind("CustAddr2") %>'/>
			</td>
		</tr>
		<tr>
			<td>City/ST/Zip:</td>
